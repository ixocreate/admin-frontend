...
@Component({
  selector: 'formly-field-document',
  template: `
    ...
    <ng-template #modalTemplate>
      <kiwi-media-list (select)="onSelect($event)" [showTypeFilter]="false" selectedType="document"></kiwi-media-list>
    </ng-template>
  `,
})
export class FormlyFieldDocumentComponent extends FormlyFieldMediaComponent {
