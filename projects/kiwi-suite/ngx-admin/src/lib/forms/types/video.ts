...
@Component({
  ...
  template: `
    ...
    <ng-template #modalTemplate>
      <kiwi-media-list (select)="onSelect($event)" [showTypeFilter]="false" selectedType="video"></kiwi-media-list>
    </ng-template>
  `,
})
export class FormlyFieldVideoComponent extends FormlyFieldMediaComponent {
