...
@Component({
  ...
  template: `
    ...
    <ng-template #modalTemplate>
      <kiwi-media-list (select)="onSelect($event)" [showTypeFilter]="false" selectedType="audio"></kiwi-media-list>
    </ng-template>
  `,
})
export class FormlyFieldAudioComponent extends FormlyFieldMediaComponent {
