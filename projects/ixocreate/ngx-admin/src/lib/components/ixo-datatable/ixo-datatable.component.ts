...
@Component({
  selector: 'ixo-datatable',
  templateUrl: 'ixo-datatable.component.html',
})
export class IxoDatatableComponent implements OnInit {
  ...
  @Input() search = '';
  @Input() type = IxoDatatableComponent.TYPE_EDIT;
